...
def update_team(team_id):
    ...
    if request.method == "POST":
        ...
        return render_template("updated-team.html", title =f"Update {team.team_name}", page ="teams", team =team, form =form)
...
def update_project(project_id):
    ...
    if request.method == "POST":
        ...
        return render_template("updated-project.html", title =f"Update {project.project_name}", page ="projects", project =project, form =form)
